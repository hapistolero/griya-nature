...
export default function Contact(){
    ...
    return(
        <>
        <div id='contact' className='xl:relative xl:top-[1180px]  w-[100%] h-[100px] bg-black mt-[0%] jt text-[#FAD6A5] px-[15px] sm:h-fit sm:top-0 hp:relative hp:top-[250px] hp:h-fit border-white '>
              ...
              <Image className='md:ml-[20px] sm:ml-0 cursor-pointer' src='/footer/instagram.svg' width={20} height={20} ></Image>
              <Image className='ml-[20px] cursor-pointer' src='/footer/tiktok.svg' width={20} height={20} ></Image>
              <Image className='ml-[20px] cursor-pointer' src='/footer/whatsapp.svg' width={20} height={20} ></Image>
              </div>              
