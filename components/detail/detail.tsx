...
<div className="h-fit bg-white w-full p-[2em]  mt-0 mb-2 text-justify rounded-xl sm:border-t-2">
           ...
           {/* <Image className="rounded-lg mx-auto " alt='product image detail' width={200} height={200} src={product[0].url} /> */}
           ...
           <div className="grid grid-cols-2 h-fit">
            ...
            <h1 className="text-[1.5em] mt-2">{product[0].name}</h1>
           <h2 className="text-[1.2em]">{product[0].price}</h2>
           ...
           <button className="w-[19em] h-fit bg-gray-300 flex mx-auto sm:mx-0  sm:w-[50%] my-5 rounded-full md:w-[18em] md:mr-auto">
            ...
            <div className=" bg-slate-100  rounded-lg grid grid-cols-3 ">
             ...
             <div className="bg-white  rounded-lg">
                <button className="h-full w-full rounded-lg p-2 bg-yellow-500"> Add to chart</button>
