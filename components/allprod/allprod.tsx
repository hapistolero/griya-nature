...
{data.map((dat,i=1)=>(
   ...
   <div onClick={() => router.push(`/home/${dat.name}`)} id={`allProd-${i++}`} className={`h-fit flex items-center justify-center flex-col   ml-2 inline shrink-0  transition-all   hover:cursor-pointer   `}>
