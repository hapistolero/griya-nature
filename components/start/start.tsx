        ...
        <section id='start' className="h-fit w-full flex hp:flex-col text-center text-[#FAD6A5] mb-[2em]  bg-gradient-to-b from-[#395144] via-[#4E6C50] to-[#395144]  ">
         ...
         <div className="h-fit w-full flex hp:flex-col xl:flex-row">
            ...
            <div className="hp:grid hp:grid-cols-2 xl:grid-cols-4 xl:grid-row-2 hp:gap-1 sm:gap-2 xl:gap-0 w-fit h-fit mt-4 mx-auto">
                ...
                <button className="col-span-2 xl:my-5 rounded-full xl:col-span-4   bg-[#CFB997] hover:bg-[#AA8B56] text-black font-bold py-2 px-4 md:px-12 md:py-4 sm:px-10  sm:py-3 hp:px-8 border border-blue-700">MULAI</button>
