...
export default function Benefits ({scrollPosition}) {
  ...
  return (
    <>
      <div  className={'xl:h-fit xl:relative   sm:h-full xl:mt-[212vh] xl:mb-[0px] md:mb-[700px] md:h-[90vh] sm:h-[200vh] hp:h-fit hp:mb-0 scroll-smooth sm: hp1:mb-[0px]    border-white '}>
         {/* benefits */}
       <div id='benefits' className= 'md:p-[23%] w-[150%]  sm:h-[215vh] hp:h-[2100px] md:w-[150%] xl:bg-contain  bn xl:absolute xl:bottom-[0px] md:bottom-[410px]   relative left-[-170px] bg-no-repeat text-lg font-bold sm:bottom-[375px]  hp:bottom-[330px]   md:pt-[25%] md:mt-[150px]  sm:mt-[150px]  hp:bg-cover sm:h-fit hp1:pb-[100px]  landscape:h-fit benefCont  '>
        ...
        <div className='grid md:grid-cols-3 md:pr-[5%] md:pt-[0%] md:pl-[5%] grid-rows-2 gap-y-[30%] md:pb-[20%] sm:pl-[25%] xl:pl-[12%]  sm:grid-cols-2 sm:gap-0 sm:gap-y-12  xl:pt-[0vh] sm:pt-[0vh] sm:w-fit sm:h-fit sm:gap-x-24 hp:flex hp:flex-col hp:gap-20 sm:grid sm:ml-[0%] hp1:ml-[43%] hp:ml-[48%]'>
