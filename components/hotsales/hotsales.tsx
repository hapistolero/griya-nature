...
{data.map((dat,i=1)=>(
    <SwiperSlide className="pb-0 p-2 hover:scale-[1.05] transition-all ">
            <div onClick={() => router.push(`/home/${dat.name}`)} id={`section-${i++}`} className={`h-[100%} flex items-center justify-center flex-col   ml-2 inline shrink-0  transition-all   hover:cursor-pointer   `}>
